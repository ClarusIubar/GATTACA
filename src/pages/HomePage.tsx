    ...
    <>
        ...
        <div className="hero__grid">
          <div>
            ...
            <p>
              ...
              시간, 장소, 계획, 사진, 코멘트까지 한 흐름으로 연결해 그날의 장면을 다시 꺼내볼 수 있게 만듭니다.
            </p>
          ...
          <div className="train-panel">
            <strong>기록의 경로</strong>
            <p className="muted">카카오톡 단체방에서 정해진 결정이 이곳에서 하루의 기록으로 이어집니다.</p>
            <div className="train-panel__rail">
              <div className="train-panel__stop">
                <strong>1. 단체방에서 결정</strong>
                <span>투표와 일정 확정은 기존 운영 흐름 그대로 유지합니다.</span>
              </div>
              <div className="train-panel__stop">
                <strong>2. 추억열차에 기록</strong>
                <span>언제, 어디서, 무엇을, 어떻게 할지 요약합니다.</span>
              </div>
              <div className="train-panel__stop">
                <strong>3. 사진과 코멘트 보관</strong>
                <span>행사 뒤 같은 페이지에 추억의 흔적을 남깁니다.</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="shell section">
        <div className="stats">
          <article className="stat-card">
            ...
            <span className="muted">확정된 일정만 시간 순서로 모읍니다.</span>
          </article>
          <article className="stat-card">
            <small>메모리 장면</small>
      ...
      <section className="shell section">
        <div className="section-heading">
          ...
          <h2>최근 일정</h2>
          <p>캘린더보다 기록에 집중해, 각 모임을 하나의 이야기 카드로 보여줍니다.</p>
        </div>
        ...
        <div className="panel-grid">
          <article className="panel">
            <div className="section-heading">
              ...
              <h2>카카오톡 연동은 운영 흐름으로 연결합니다</h2>
            </div>
            <ul className="rail-list">
              <li>단체방에서 투표와 일정 확정</li>
              <li>운영자 또는 승인 회원이 추억열차에 결과 정리</li>
              <li>행사 뒤 같은 페이지에 사진과 코멘트 추가</li>
            </ul>
          </article>
          ...
          <article className="panel">
            ...
            <ul className="rail-list">
              <li>비로그인 사용자는 기록 열람만 가능합니다.</li>
              <li>승인 대기 사용자는 안내 화면만 확인합니다.</li>
              <li>승인 회원은 등록과 수정이 가능합니다.</li>
              <li>운영자는 승인 관리와 삭제 권한을 가집니다.</li>
            </ul>
          </article>
        </div>
      </section>
