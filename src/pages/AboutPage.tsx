      ...
      <div className="two-column">
        <article className="panel panel--dark">
          <div className="section-heading">
            ...
            <h2>추억열차는 약속을 기록으로 바꾸는 정거장입니다.</h2>
            <p>
              단체방의 대화는 빠르게 흘러가지만, 함께 보낸 하루는 오래 남습니다. 추억열차는 카카오톡
          ...
          <ul className="rail-list">
            <li>캘린더 서비스가 아니라 확정된 모임의 기록 보관소입니다.</li>
            <li>각 일정은 언제, 어디서, 무엇을, 어떻게 할지를 분명히 남깁니다.</li>
            <li>사진과 코멘트는 일정 하위의 메모리로 연결됩니다.</li>
        ...
        <article className="panel">
          ...
          <ul className="rail-list">
            ...
            <li>문서, 구현, 배포 기록은 저장소 docs와 GitHub Wiki 원본에 함께 남깁니다.</li>
          </ul>
        </article>
      </div>
    </section>
